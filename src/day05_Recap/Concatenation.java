...
public class Concatenation {
	...
	public static void main(String[] args) {
		...
		System.out.println(1+"123"+4+5); // 12345
        ...
        System.out.println(BookName);
				...
				System.out.println(MyInfo);
	         	...
	         	System.out.println('3'+3);		//54 '3'-ASCII
				
				System.out.println("3"+'3'); // 33 char to string. char is character
				
				System.out.println(12+'3'); //63  12+51 ASCII
